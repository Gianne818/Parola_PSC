...
CREATE TABLE IF NOT EXISTS public.users (
    ...
    preferred_advisory_time TIME NOT NULL DEFAULT '05:00:00', -- User input from Frontend (e.g. 04:00, 05:00, 06:00)
    coop_id UUID,
...
BEGIN
    ...
    SELECT 
        ...
        CASE 
            WHEN degrees(ST_Azimuth(v_user_geom, g.centroid_geom)) BETWEEN 348.75 OR 11.25 THEN 'N'
