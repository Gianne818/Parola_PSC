...
export const MapComponent: React.FC<MapComponentProps> = ({
  ...
  return (
    <div className="relative w-full bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-teal-950 rounded-[2rem] overflow-hidden shadow-inner flex flex-col md:flex-row select-none">
      
      {/* ECDIS Nautical Chart Container */}
      <div className="relative flex-1 bg-[#EEF5F3] dark:bg-[#0B1513] min-h-[450px] md:min-h-[580px]">
        <MapInner
          hotspots={hotspots}
