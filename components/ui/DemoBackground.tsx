...
export const DemoBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[120%] h-[80%] rounded-full bg-gradient-to-br from-[#00B37E]/5 via-[#00B37E]/2 to-transparent blur-[120px] dark:from-[#00B37E]/10 dark:via-transparent dark:to-transparent" />
