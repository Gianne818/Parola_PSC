...
export default function ProfilePage() {
  ...
  const { userProfile, language, changeLanguage, showToast } = useApp();
  ...
  return (
    <AuthLayout>
      <div className="space-y-6 pb-16 pt-2">
        ...
        {/* Combined Card: Language Translation & Geoproximity */}
        <div className="bg-white border border-gray-200/80 rounded-[2.5rem] p-6 sm:p-8 shadow-md">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">

            {/* Left Section: Language Translation System */}
                        ...
                        <div>
                          <span
                            className={`font-display font-black text-xs block ${
                              isSelected ? "text-[#00B074]" : "text-slate-800"
                            }`}
                          >
                            {item.label}
                          </span>
            ...
            {/* Right Section: Geoproximity Geocenter */}
            <div className="space-y-5 lg:border-l lg:border-gray-200/80 lg:pl-8 pt-6 lg:pt-0 border-t lg:border-t-0 border-gray-100">
