...
// Validate ../../app/api/gemini/advisor/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/gemini/advisor">> = Specific
  const handler = {} as typeof import("../../app/api/gemini/advisor/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
